...
public class Anti_L extends Piece {
	public Anti_L(Image images) {
		...
		list.add(new Square(images, 0, images.getHeight(null) * 2));
		list.add(new Square(images, images.getWidth(null), images.getHeight(null) * 2));
		...
		list3.add(new Square(images, images.getWidth(null), 0));
		list3.add(new Square(images, images.getWidth(null) * 2, 0));
		list3.add(new Square(images, images.getWidth(null) * 2, images.getHeight(null)));

		/*
		 * * * * *
		 */
		List<Square> list4 = new ArrayList<>();
		list4.add(new Square(images, 0, 0));
		list4.add(new Square(images, images.getWidth(null), 0));
		list4.add(new Square(images, 0, images.getHeight(null)));
		list4.add(new Square(images, 0, images.getHeight(null) * 2));
